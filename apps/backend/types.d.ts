...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'WorkflowOrchestrator': ApiRouteHandler<{ message: string; userId: string; context?: { symbols?: string[]; timeframe?: string; riskTolerance?: 'conservative' | 'moderate' | 'aggressive' } }, unknown, { topic: 'workflow.started'; data: { workflowId: string; userId?: string; type?: string; stepIndex?: number; agent?: string; task?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string; streamKey?: string } } | { topic: 'workflow.agent.started'; data: { workflowId: string; stepIndex: number; agent: string; task: string; userId?: string; streamKey?: string; type?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string } } | { topic: 'workflow.agent.completed'; data: { workflowId: string; userId?: string; type?: string; stepIndex?: number; agent?: string; task?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string; streamKey?: string } } | { topic: 'workflow.completed'; data: { workflowId: string; userId?: string; type?: string; stepIndex?: number; agent?: string; task?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string; streamKey?: string } }>
    'TestStream': ApiRouteHandler<Record<string, unknown>, unknown, never>
    ...
    'ChatStream': ApiRouteHandler<{ message: string; assistantType?: 'general' | 'analyst' | 'trader' | 'advisor' | 'riskManager' | 'economist'; userId: string; context?: { symbols?: string[]; timeframe?: string; riskTolerance?: string } }, unknown, never>
    ...
    'AgentExecutor': EventHandler<{ workflowId: string; stepIndex: number; agent: string; task: string }, { topic: 'workflow.agent.completed'; data: { workflowId: string; userId?: string; type?: string; stepIndex?: number; agent?: string; task?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string; streamKey?: string } } | { topic: 'workflow.agent.progress'; data: { workflowId: string; userId?: string; type?: string; stepIndex?: number; agent?: string; task?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string; streamKey?: string } } | { topic: 'workflow.completed'; data: { workflowId: string; userId?: string; type?: string; stepIndex?: number; agent?: string; task?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string; streamKey?: string } } | { topic: 'workflow.agent.started'; data: { workflowId: string; stepIndex: number; agent: string; task: string; userId?: string; streamKey?: string; type?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string } }>
    'ChatStreamWS': ApiRouteHandler<{ message: string; assistantType?: 'general' | 'analyst' | 'trader' | 'advisor' | 'riskManager' | 'economist'; userId: string; streamId?: string; context?: { symbols?: string[]; timeframe?: string; riskTolerance?: string } }, unknown, never>
    ...
    'ChatPolling': ApiRouteHandler<{ message: string; assistantType?: 'general' | 'analyst' | 'trader' | 'advisor' | 'riskManager' | 'economist'; userId: string; context?: { symbols?: string[]; timeframe?: string; riskTolerance?: string } }, unknown, never>
  }
}