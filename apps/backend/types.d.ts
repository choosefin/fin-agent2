...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'WorkflowOrchestrator': ApiRouteHandler<{ message: string; userId: string; context?: { symbols?: string[]; timeframe?: string; riskTolerance?: 'conservative' | 'moderate' | 'aggressive' } }, unknown, { topic: 'workflow.started'; data: { workflowId?: string; userId?: string; type?: string; stepIndex?: number; agent?: string; task?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string } } | { topic: 'workflow.agent.started'; data: { workflowId: string; stepIndex: number; agent: string; task: string } } | { topic: 'workflow.agent.completed'; data: { workflowId?: string; userId?: string; type?: string; stepIndex?: number; agent?: string; task?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string } } | { topic: 'workflow.completed'; data: { workflowId?: string; userId?: string; type?: string; stepIndex?: number; agent?: string; task?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string } }>
    ...
    'AgentExecutor': EventHandler<{ workflowId: string; stepIndex: number; agent: string; task: string }, { topic: 'workflow.agent.completed'; data: { workflowId?: string; userId?: string; type?: string; stepIndex?: number; agent?: string; task?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string } } | { topic: 'workflow.agent.progress'; data: { workflowId?: string; userId?: string; type?: string; stepIndex?: number; agent?: string; task?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string } } | { topic: 'workflow.completed'; data: { workflowId?: string; userId?: string; type?: string; stepIndex?: number; agent?: string; task?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string } } | { topic: 'workflow.agent.started'; data: { workflowId: string; stepIndex: number; agent: string; task: string } }>
