...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'WorkflowTriggerHandler': EventHandler<{ workflowId: string; userId: string; message: string; context?: { symbols?: string[]; timeframe?: string; riskTolerance?: string }; agents: string[] }, { topic: 'workflow.started'; data: { workflowId: string; userId?: string; type?: string; stepIndex?: number; agent?: string; task?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string; streamKey?: string } } | { topic: 'workflow.agent.started'; data: { workflowId: string; stepIndex: number; agent: string; task: string; userId?: string; streamKey?: string; type?: string; data?: unknown; results?: unknown; message?: string; progress?: number; error?: string; timestamp?: string } }>
